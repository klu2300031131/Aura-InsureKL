...
const DashboardPage = () => {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="header animate-slide-up" style={{ gridColumn: 'span 12' }}>
        <div className="header-title-container">
          <div className="flex gap-4 align-center mb-1">
            ...
            <span className="badge active glow-pulse" style={{ borderColor: activePlan?.color, color: activePlan?.color, background: `${activePlan?.color}22` }}>Coverage Active</span>
          </div>
      ...
      <div style={{ gridColumn: 'span 8', display: 'flex', gap: '1.5rem', flexDirection: 'column' }}>
